# Este Script Python gera perfis de aerofólio do tipo NACA 4 e S1223 no software Catia V5
...
part_document = documents.Open("D:\\AERO-zero\\CADs\\Catia Aero-zero\\RW-zero.CATPart")      ###### Aqui é caminho onde o código irá salvar o arquivo ######
part = part_document.Part

# RW-AF-Flat-0  /  RW-Flat-zero   ("C:\\Users\\carlo\\Desktop\\AERO-zero\\CADs\\Catia Aero-zero\\RW-zero.CATPart")


# ("C:\\Users\\carlo\\Desktop\\AERO-zero\\CADs\\Catia Aero-zero\\RW-zero.CATPart") 
...
# Downforce
gap_A, overhang_A = 70, -39.39   # [mm, mm]
gap_B, overhang_B = 100, -69.24   # [mm, mm] 

#Stoled
#gap_A, overhang_A = 174, -82.39   # [mm, mm]
#gap_B, overhang_B = 105, -109.24   # [mm, mm] 
...
chord_lengths = [500, 151.51, 116.16, 500, 151.16, 116.16]  # [mm, mm, mm, mm, mm, mm]
...
airfoil_parameters = [
   ...
   # Downforce
    ...
    {"airfoil_type": "S1223", "name": "Second Element", "x_offset": x_positions[1], "z_offset": z_positions[1], "chord": chord_lengths[1], "angle": 44, "plane_position": 0, "use_offset_plane": False},
    {"airfoil_type": "S1223", "name": "Third Element", "x_offset": x_positions[2], "z_offset": z_positions[2], "chord": chord_lengths[2], "angle": 73, "plane_position": 0, "use_offset_plane": False},
    
    {"airfoil_type": "S1223", "name": "Main Element_EXT", "x_offset": x_positions[0], "z_offset": z_positions[0], "chord": chord_lengths[3], "angle": 7, "plane_position": 500, "use_offset_plane": True},
    {"airfoil_type": "S1223", "name": "Second Element_EXT", "x_offset": x_positions[1], "z_offset": z_positions[1], "chord": chord_lengths[4], "angle": 44, "plane_position": 500, "use_offset_plane": True},
    {"airfoil_type": "S1223", "name": "Third Element_EXT", "x_offset": x_positions[2], "z_offset": z_positions[2], "chord": chord_lengths[5], "angle": 73, "plane_position": 500, "use_offset_plane": True}, 
    
   #Stoled
   # {"airfoil_type": "S1223", "name": "Main Element", "x_offset": x_positions[0], "z_offset": z_positions[0], "chord": chord_lengths[0], "angle": 7, "plane_position": 0, "use_offset_plane": False},
   # {"airfoil_type": "S1223", "name": "Second Element", "x_offset": x_positions[1], "z_offset": z_positions[1], "chord": chord_lengths[1], "angle": 0, "plane_position": 0, "use_offset_plane": False},
   # {"airfoil_type": "S1223", "name": "Third Element", "x_offset": x_positions[2], "z_offset": z_positions[2], "chord": chord_lengths[2], "angle": 0, "plane_position": 0, "use_offset_plane": False},
    
   # {"airfoil_type": "S1223", "name": "Main Element_EXT", "x_offset": x_positions[0], "z_offset": z_positions[0], "chord": chord_lengths[3], "angle": 7, "plane_position": 500, "use_offset_plane": True},
   # {"airfoil_type": "S1223", "name": "Second Element_EXT", "x_offset": x_positions[1], "z_offset": z_positions[1], "chord": chord_lengths[4], "angle": 0, "plane_position": 500, "use_offset_plane": True},
   # {"airfoil_type": "S1223", "name": "Third Element_EXT", "x_offset": x_positions[2], "z_offset": z_positions[2], "chord": chord_lengths[5], "angle": 0, "plane_position": 500, "use_offset_plane": True},  
...
for airfoil in airfoil_parameters:
    x_coords, z_coords = select_airfoil(airfoil["airfoil_type"])  # Alterado de Y para Z
    
    x_coords *= airfoil["chord"]
    z_coords *= airfoil["chord"]  # Alterado de Y para Z
    
    x_rot, z_rot = rotate_points(x_coords, z_coords, airfoil["angle"])  # Alterado de Y para Z
    
    x_rot += airfoil["x_offset"]
    z_rot += airfoil["z_offset"]  # Alterado de Y para Z
...
# python D:\AERO-zero\Python\PyCatia_RWAF-S.py